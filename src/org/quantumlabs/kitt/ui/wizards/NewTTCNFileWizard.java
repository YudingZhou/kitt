 ...
 * target container. The wizard creates one file with the extension ".ttcn". If
 * a sample multi-page editor (also available as a template) is registered for
 * the same extension, it will be able to open it.
 */

public class NewTTCNFileWizard extends Wizard implements INewWizard {
	private NewTTCNFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for NewTTCNFileWizard.
	 */
	public NewTTCNFileWizard() {
		super();
	...
	public void addPages() {
		page = new NewTTCNFileWizardPage(selection);
		addPage(page);
	}
	...
	private InputStream openContentStream(String moduleName) {
		String contents = createContentTemplate(moduleName);
		return new ByteArrayInputStream(contents.getBytes());
	}

	private String createContentTemplate(String moduleName) {
